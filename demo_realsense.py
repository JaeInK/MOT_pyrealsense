                ...
                if bbox_xywh is not None:
                    ...
                    if len(outputs) > 0:
                        ...
                        for i,box in enumerate(bbox_xyxy):
                            ...
                            cv2.rectangle(ori_im,(x1, y1),(x2,y2),color,3)
                            cv2.rectangle(ori_im,(x1, y1),(x1+t_size[0]+3,y1+t_size[1]+4), color,-1)
                            cv2.putText(ori_im,label,(x1,y1+t_size[1]+4), cv2.FONT_HERSHEY_PLAIN, 2, [255,255,255], 2)
